...
FILE_OWNERSHIP = {
    ...
    AgentRole.WIRING_ENGINEER: ["main.py", "__init__.py", "config.py", "requirements.txt", "README.md", "render.yaml", "Dockerfile", ".dockerignore", ".gitignore", ".env.example", ".flaskenv", "docker-compose.yml", "pytest.ini", "pyproject.toml", "*.md", "*.txt", "*.yaml", "*.yml", "*.toml", "*.ini"]
}
...
class AgentDeliverable:
    ...
    def _matches_pattern(self, filename: str, pattern: str) -> bool:
        """Simple glob matching for patterns like *.yml or test_*.py."""
        if '*' in pattern:
